...
Für die Analyse mit Hilfe des Prototyps wurde neben den zwei Analysemethoden mit und ohne GIS-Daten noch vier weitere Entscheidungsbäume ausgewählt. Die ausgewählten Entscheidungsbäume wurden auf Grund ihres Abschneidens in Abschnitt \ref{rapidMinerResultat} \nameref{rapidMinerResultat} ausgewählt und sind folgende:
\begin{pitemize}
