...
Wann immer ein Verkehrsmittelwechsel stattgefunden hat, muss ein GPX-Tracksegment in die Trainingsdaten eingepflegt werden. Dieses Segment muss zusätzlich auf über ein Attribut ``type`` verfügen, welches den eigentlichen Verkehrsmitteltyp angibt.
