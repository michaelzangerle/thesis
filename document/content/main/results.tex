...
\end{tabular}
\caption{Genauigkeit von Entscheidungsbäumen mit verschiedenen Entscheidungskriterien und Trainingsdatenvarianten (siehe Abschnitte ``\ref{entscheidungsbaumAlgorithmen} \nameref{entscheidungsbaumAlgorithmen}`` und ``\ref{entschiedungskriterienRapidMiner} \nameref{entschiedungskriterienRapidMiner}``)}
